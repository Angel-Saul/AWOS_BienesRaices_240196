...
|---|---|---|---|
|1.| Configuración incial del Proyecto (NodeJS) | ❌ | ❌ |
|2.| Routing y Request (Peticiones) | ❌ | ❌ |
...
|7.| Implementación de la Funcionalidad (Feature) Recuperación de Contraseña (Password Recovery) | ❌ | ❌ |
...
---
Posteriormente se ubicaran imágenes del proyecto

## Creado por:
Angel Saúl Barrios Martínez - 240196