...
import express from "express";
import session from "express-session"; // Importante para mantener la sesión
import passport from "passport"; // El motor de autenticación
import dotenv from "dotenv"; // Para leer tus API Keys del .env
import usuarioRoutes from "./routes/usuarioRoutes.js";
import { connectDB } from "./config/db.js";
import "./config/passport.js"; // Importamos la configuración de las estrategias (hay que crear este archivo)
...
// 1. Configurar Sesiones (Obligatorio para Passport)
app.use(session({
    secret: process.env.BACKEND_URL || 'palabra_secreta_provisional', // Usa una frase segura
    resave: false,
...
// Conexión a DB e inicio de servidor
await connectDB();
